---
title: Development
description: Building, project layout, CI, and releasing nf-diff.
---
...
This documentation site itself is built with Astro + Starlight from `website/`
and deployed by `.github/workflows/docs.yml` — see that workflow for how
`/latest/` and versioned snapshots are published to the `gh-pages` branch.
